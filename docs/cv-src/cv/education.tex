...
%---------------------------------------------------------
  ...
  \cventry
    ...
    {
    \begin{cvitems} % Description(s) bullet points
        \item {\textbf{1st place (academic)} at the international ACM RecSys Challenge 2021: co-developed the winning ML solution on the Twitter engagement dataset with the university team under prof. Paolo Cremonesi, using Dask, CatBoost, and XGBoost.}
